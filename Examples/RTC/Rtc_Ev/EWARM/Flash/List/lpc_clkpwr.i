...
void CLKPWR_SetCLKDiv (uint8_t ClkType, uint8_t DivVal)
{
	...
	{
	case ((uint32_t)(0)):
		tmp = 	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL & ~(0x1F);
		tmp |=  DivVal & 0x1F;
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL = tmp;
		SystemCoreClockUpdate(); 
		break;
	case ((uint32_t)(1)):
		tmp = 	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL & ~(0x1F);
		tmp |=  DivVal & 0x1F;
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL = tmp;
		SystemCoreClockUpdate(); 
		break;
	case ((uint32_t)(2)):
		tmp = 	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EMCCLKSEL & ~(0x01);
		tmp |=  DivVal & 0x01;
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EMCCLKSEL = tmp;
		SystemCoreClockUpdate(); 
		break;
	case ((uint32_t)(3)):
		tmp = 	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL & ~(0x1F);
		tmp |=  DivVal & 0x1F;
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL |= DivVal & 0x1F;
		SystemCoreClockUpdate(); 
		break;
	default:
		while(1);
