...
void RTC_IRQHandler(void)
{
  ...
  if(RTC_GetIntPending(((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_INT_ALARM|RTC_INT_COUNTER_INCREASE))
  {
	RTC_ClearIntPending(((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_INT_ALARM|RTC_INT_COUNTER_INCREASE);
  }
  ...
  evt_cnt =  RTC_ER_GetEventCount((2)); 
  RTC_ER_GetFirstTimeStamp((2),(RTC_ER_TIMESTAMP_Type*) &FirstTimeStamp);
  RTC_ER_GetLastTimeStamp((2), (RTC_ER_TIMESTAMP_Type*) &LastTimeStamp);
...
void SetSystemTime(void)
{
	...
	RTC_Init(((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ));

	 
	RTC_ResetClockTickCounter(((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ));
	RTC_Cmd(((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), ENABLE);

	 
	
	RTC_SetTime (((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_TIMETYPE_SECOND, 0);
	RTC_SetTime (((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_TIMETYPE_MINUTE, 45);
	RTC_SetTime (((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_TIMETYPE_HOUR, 18);
	RTC_SetTime (((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_TIMETYPE_MONTH, 1);
	RTC_SetTime (((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_TIMETYPE_YEAR, 2012);
	RTC_SetTime (((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_TIMETYPE_DAYOFMONTH, 1);
    RTC_SetTime (((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_TIMETYPE_DAYOFYEAR, 1);
    RTC_SetTime (((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), RTC_TIMETYPE_DAYOFWEEK, 6);

	
	RTC_GetFullTime (((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) ), &RTCFullTime);
	_db_msg((UART_0), "Current time set to: ");
	_db_dec((UART_0), (RTCFullTime . HOUR)); _db_msg((UART_0), ":");
	_db_dec((UART_0), (RTCFullTime . MIN)); _db_msg((UART_0), ":");
	_db_dec((UART_0), (RTCFullTime . SEC)); _db_msg((UART_0), "  ");
	_db_dec((UART_0), (RTCFullTime . DOM)); _db_msg((UART_0), "/");
	_db_dec((UART_0), (RTCFullTime . MONTH)); _db_msg((UART_0), "/");
	_db_dec_16((UART_0), (RTCFullTime . YEAR)); _db_msg((UART_0), " (DOY = ");
    _db_dec_16((UART_0), (RTCFullTime . DOY)); _db_msg((UART_0), ", DOW = ");
    _db_dec_16((UART_0), (RTCFullTime . DOW)); _db_msg_((UART_0), ")");
}
...
start:
	...
	ErInit.InputChannel[(2)].IntWake= TRUE;
	if(RTC_ER_Init(&ErInit) == SUCCESS)
	{
		...
		{
             uart_in = 0;
			_db_get_char_nonblocking((UART_0),&uart_in);
			switch(uart_in)
			{
				case 'S':
				case 's':
                    _db_msg_((UART_0), "Enter to Sleep Mode");
					CLKPWR_Sleep();
                    _db_msg_((UART_0), "\n\rSystem wake-up!\n\r");
					break;
				case 'P':
				case 'p':
                    _db_msg_((UART_0), "Enter to Power Down Mode");
					CLKPWR_PowerDown();
                    SystemInit();
                	debug_frmwrk_init();
                	_db_msg_((UART_0), "\n\rSystem wake-up!\n\r");
				...
				case 'D':
				case 'd':
                    _db_msg_((UART_0), "Enter to Deep Power Down Mode");
    		...
    		if(evt_cnt)
			{
                _db_msg((UART_0), "Event Count: ");_db_dec((UART_0), evt_cnt);_db_msg_((UART_0), "");
				_db_msg((UART_0), "First TimeStamp: ");
				_db_dec((UART_0), (FirstTimeStamp . HOUR)); _db_msg((UART_0), ":");
				_db_dec((UART_0), (FirstTimeStamp . MIN)); _db_msg((UART_0), ":");
				_db_dec((UART_0), (FirstTimeStamp . SEC)); _db_msg((UART_0), ", DOY = ");
				_db_dec((UART_0), (FirstTimeStamp . DOY)); _db_msg_((UART_0), "");
				_db_msg((UART_0), "Last TimeStamp: ");
				_db_dec((UART_0), (LastTimeStamp . HOUR)); _db_msg((UART_0), ":");
				_db_dec((UART_0), (LastTimeStamp . MIN)); _db_msg((UART_0), ":");
				_db_dec((UART_0), (LastTimeStamp . SEC));  _db_msg((UART_0), ", DOY = ");
				_db_dec((UART_0), (LastTimeStamp . DOY)); _db_msg_((UART_0), "");
                evt_cnt = 0;
			}
