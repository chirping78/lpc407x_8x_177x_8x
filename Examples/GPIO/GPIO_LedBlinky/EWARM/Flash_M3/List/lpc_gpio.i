...
static LPC_GPIO_TypeDef *GPIO_GetPointer(uint8_t portNum)
{
	...
	switch (portNum)
	{
		...
		case 5:
			pGPIO = ((LPC_GPIO_TypeDef *) ((0x20080000UL) + 0x180A0) );
			break;
...
static GPIO_Byte_TypeDef *FIO_ByteGetPointer(uint8_t portNum)
{
	...
	switch (portNum)
	{
		...
		case 5:
			pFIO = ((GPIO_Byte_TypeDef *)(((0x20080000UL) + 0x180A0)));
			break;
...
void GPIO_Init(void)
{
	CLKPWR_ConfigPPWR(((uint32_t)(1<<15)), ENABLE);
...
void GPIO_Deinit(void)
{
	CLKPWR_ConfigPPWR(((uint32_t)(1<<15)), DISABLE);
...
{
	if((portNum == 0) && (edgeState == 0))
		return (((((((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO0IntStatR)>>pinNum)& 0x1) != 0)? ENABLE:DISABLE);
	else if ((portNum == 2) && (edgeState == 0))
		return (((((((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntStatR)>>pinNum)& 0x1) != 0)? ENABLE:DISABLE);
	else if ((portNum == 0) && (edgeState == 1))
		return (((((((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO0IntStatF)>>pinNum)& 0x1) != 0)? ENABLE:DISABLE);
	else if ((portNum == 2) && (edgeState == 1))
		return (((((((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntStatF)>>pinNum)& 0x1) != 0)? ENABLE:DISABLE);
	else
