...
uint32_t SystemCoreClock = ((( (12000000UL)) * ((0x00000009 & 0x1F) + 1)) / (0x00000101 & 0x1F)); 
uint32_t PeripheralClock = ((( (12000000UL)) * ((0x00000009 & 0x1F) + 1)) / (0x00000002 & 0x1F));  
uint32_t EMCClock		 = (((( (12000000UL)) * ((0x00000009 & 0x1F) + 1)) / (0x00000101 & 0x1F)) / ((0x00000001 & 0x01) + 1));  
...
void SystemCoreClockUpdate (void)             
{
  ...
  if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL &0x100) == 0) {             
    if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKSRCSEL & 0x01) == 0) {     
		  SystemCoreClock = ((((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL & 0x1F)) == 0) ? 0: ((12000000UL))/((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL & 0x1F)));
          PeripheralClock = ((((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL & 0x1F)) == 0) ? 0: ((12000000UL))/((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL & 0x1F)));
          EMCClock        = (SystemCoreClock / ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EMCCLKSEL & 0x01)+1));
    }
    else {                                         
    ...
    if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x100) == 0) {         
      ...
      if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKSRCSEL & 0x01) == 0) {     
          uint8_t mul = ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x1F) + 1);
          uint8_t cpu_div = (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL & 0x1F);
          uint8_t per_div = (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL & 0x1F);
          uint8_t emc_div = (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EMCCLKSEL & 0x01)+1;
          SystemCoreClock = (((cpu_div) == 0) ? 0: ((12000000UL) * mul)/(cpu_div));
          PeripheralClock = (((per_div) == 0) ? 0: ((12000000UL) * mul)/(per_div));
  ...
  if(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL & (0x01<<8))
  {
	  ...
	  case 6:
            {
                 uint8_t mul = ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x1F) + 1);
                 uint8_t usb_div = (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL & 0x1F);
		  if(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKSRCSEL & 0x01)	
			  USBClock = ( (12000000UL)) * mul / usb_div;
		  else 
			  USBClock = (12000000UL) * mul / usb_div;
            }
            break;
...
void fpu_init(void)
{
    ...
    volatile uint32_t* regCpacr = (uint32_t*) 0xE000ED88;
    volatile uint32_t* regMvfr0 = (uint32_t*) 0xE000EF40;
    volatile uint32_t* regMvfr1 = (uint32_t*) 0xE000EF44;
    volatile uint32_t Cpacr;
    ...
    vfpPresent = ((0x10110021 == Mvfr0) && (0x11000011 == Mvfr1));
...
fpu_init();
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL   = 0x00000101;       
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL = 0x00000201;     
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EMCCLKSEL = 0x00000001;     
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->SPIFISEL  = 0x00000002;      
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PBOOST 	|= 0x03;			 
